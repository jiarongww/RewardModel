...
def evaluate(mode: str, root_dir: str, data_path: str = os.path.join(root_path,'datasets/HPD_v2_test/benchmark'), checkpoint_path: str = None, batch_size: int = 20, hps_version: str = "v2.1") -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default=os.path.join("../pretrained_model/HPS_v2",'HPS_v2_compressed.pt'), help='path to checkpoint')
